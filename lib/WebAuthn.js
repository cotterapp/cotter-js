...
var WebAuthn = /** @class */ (function () {
    ...
    WebAuthn.prototype.init = function () {
        var path = enum_1.default.JSURL + "/webauthn?type=" + this.config.Type + "&domain=" + this.config.Domain + "&api_key=" + this.config.ApiKeyID + "&state=" + this.state + "&id=" + this.containerID + "&identifier=" + this.config.Identifier;
        this.Modal = new ModalMaker_1.default(this.modalID, this.containerID, this.cotterIframeID, this.cancelDivID, path);
    ...
    WebAuthn.prototype.onErrorDisplay = function (error) {
        ...
        if (err.includes("timed out")) {
            ...
            err =
                "Please <a href=\"https://help.cotter.app/en/articles/4572882-how-to-enable-third-party-cookies-to-use-cotter\" target=\"_new\">enable third-party cookies in your browser settings</a>";
        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        api = new API_1.default(this.config.ApiKeyID);
                        return [4 /*yield*/, api.finishWebAuthnLogin(identifier, this.config.IdentifierType || binder_1.IDENTIFIER_TYPE.EMAIL, credential, origin, publicKey)];
                    case 1:
                        resp = _a.sent();
                        if (resp && resp.user) {
