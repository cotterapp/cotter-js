...
var MicroModal_1 = __importDefault(require("./components/MicroModal"));
...
var WebAuthn = /** @class */ (function () {
    ...
    WebAuthn.prototype.init = function () {
        ...
        modalStyle.href = enum_1.default.AssetURL + "/lib/modal.css";
    ...
    WebAuthn.prototype.show = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    this.activeModal = MicroModal_1.default.show("modal-cotterWebAuthn", {});
                }
                catch (e) {
    ...
    WebAuthn.prototype.close = function () {
        if (this.activeModal)
            ...
            MicroModal_1.default.close("modal-cotterWebAuthn");
        this.removeIframe();
        this.removeSelf();
    };
