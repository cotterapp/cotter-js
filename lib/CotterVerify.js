...
var CotterVerify = /** @class */ (function () {
        ...
        window.addEventListener("message", function (e) {
            ...
            switch (data.callbackName) {
                ...
                case cID + "ON_SOCIAL_LOGIN_REQUEST":
                    window === null || window === void 0 ? void 0 : window.sessionStorage.setItem(SocialLogin_1.default.LOGIN_KEY, btoa(JSON.stringify({
                        code_verifier: _this.verifier,
                        redirect_url: window.location.href,
                    })));
                    var url = SocialLogin_1.default.getAuthorizeURL((_a = data.payload) === null || _a === void 0 ? void 0 : _a.provider, _this.config.ApiKeyID, _this.state, window.location.href, _this.challenge);
                ...
                case cID + "ON_BEGIN":
                    ...
                    if (_this.config.FormID) {
                        var resp = fetch(enum_1.default.WorkerURL + "/screening/form?identifier=" + encodeURIComponent(data.payload.identifier) + "&form-id=" + encodeURIComponent(_this.config.FormID), {
                            method: "GET",
                            headers: {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        socialLoginSession = window === null || window === void 0 ? void 0 : window.sessionStorage.getItem(SocialLogin_1.default.LOGIN_KEY);
                        // Redirect To Connect
                        if (action === binder_1.SOCIAL_LOGIN_ACTION.CONNECT) {
                            socialLogin = new SocialLogin_1.default(this.config);
                            socialLogin
                                .show()
                                .then(function (resp) {
                    ...
                    case 1:
                        _c.sent();
                        window === null || window === void 0 ? void 0 : window.sessionStorage.removeItem(SocialLogin_1.default.LOGIN_KEY);
                        ...
                        _c.label = 2;
                    case 2:
                        if (auth_method === binder_1.AUTHENTICATION_METHOD.MAGIC_LINK) {
    ...
    CotterVerify.prototype.showEmailForm = function () {
        ...
        this.config.Type = binder_1.IDENTIFIER_TYPE.EMAIL;
        return this.showForm();
    };
    CotterVerify.prototype.showPhoneForm = function () {
        this.config.IdentifierField = "phone";
        this.config.Type = binder_1.IDENTIFIER_TYPE.PHONE;
        return this.showForm();
    };
    ...
    CotterVerify.prototype.submitAuthorizationCode = function (payload, code_verifier, redirect_url, auth_method) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                self = this;
                url = enum_1.default.BackendURL + "/verify/get_identity?oauth_token=true";
                if (auth_method) {
                    url = url + "&auth_method=" + auth_method;
                }
                fRetry = fetch_retry_1.default(fetch);
                fRetry(url, {
                    method: "POST",
                    headers: {
