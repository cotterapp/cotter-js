...
exports.getModalHeight = exports.lightOrDark = exports.isIFrame = exports.verificationProccessPromise = exports.challengeFromVerifier = exports.base64urldecode = exports.base64urlencode = exports.generateVerifier = exports.getAPIKeyIDFromAttr = void 0;
var WebAuthn_1 = __importDefault(require("./WebAuthn"));
var constants_1 = require("./constants");
function dec2hex(dec) {
    return ("0" + dec.toString(16)).substr(-2);
}
function getAPIKeyIDFromAttr() {
    var _a;
    var apiKeyID = (_a = document
        .querySelector("[" + constants_1.ATTR_API_KEY_ID + "]")) === null || _a === void 0 ? void 0 : _a.getAttribute("" + constants_1.ATTR_API_KEY_ID);
    if (!apiKeyID) {
        throw new Error("You need to specify the " + constants_1.ATTR_API_KEY_ID + " when adding this <script>.");
    }
    return apiKeyID;
}
exports.getAPIKeyIDFromAttr = getAPIKeyIDFromAttr;
...
var verificationProccessPromise = function (self) {
...
exports.verificationProccessPromise = verificationProccessPromise;
var isIFrame = function (input) { return input !== null && input.tagName === "IFRAME"; };
...
var getModalHeight = function (customization) {
...
exports.getModalHeight = getModalHeight;
