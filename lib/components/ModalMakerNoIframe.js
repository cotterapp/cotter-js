...
var ModalMakerNoIframe = /** @class */ (function () {
    function ModalMakerNoIframe(modalID, containerID, cancelDivID) {
        this.modalID = modalID;
        this.containerID = containerID;
        this.cancelDivID = cancelDivID;
    }
    ModalMakerNoIframe.prototype.initModal = function (onCloseDiv, modalDiv) {
        // Setup Font
    ...
    ModalMakerNoIframe.prototype.showModal = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    this.activeModal = MicroModal_1.default.show(this.modalID, {});
                }
                catch (e) {
    ...
    ModalMakerNoIframe.prototype.closeModal = function () {
        if (this.activeModal)
...
exports.default = ModalMakerNoIframe;
//# sourceMappingURL=ModalMakerNoIframe.js.map