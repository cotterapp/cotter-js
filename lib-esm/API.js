            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios.post("" + CotterEnum.BackendURL + path, req, config)];
                    case 1:
                        resp = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        path = "/token/" + this.apiKeyID;
                        return [4 /*yield*/, axios.delete("" + CotterEnum.BackendURL + path, config)];
                    case 1:
                        resp = _a.sent();
                        return [2 /*return*/, resp.data];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios.get("" + CotterEnum.BackendURL + path + "?identifier=" + encodeURIComponent(identifier), config)];
                    case 1:
                        resp = _a.sent();
                        if (resp.data &&
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios.post("" + CotterEnum.BackendURL + path + "?identifier=" + encodeURIComponent(identifier), data, config)];
                    case 1:
                        resp = _a.sent();
                        if (resp.data && resp.data.publicKey) {
                            return [2 /*return*/, serverToCreationOptions(resp.data.publicKey)];
                        }
                        throw resp;
                    case 2:
                        err_4 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        data = CredentialToServerCredentialCreation(credential);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        resp = _a.sent();
                        if (resp.data && resp.data.publicKey) {
                            return [2 /*return*/, serverToRequestOptions(resp.data.publicKey)];
                        }
                        throw resp;
                    case 2:
                        err_6 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        data = CredentialToServerCredentialRequest(credential);
